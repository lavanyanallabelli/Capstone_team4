...
// Check for missing environment variables (warn but don't fail build)
const missingVars = [];
...
if (missingVars.length > 0) {
    ...
    console.warn('Using fallback values for build. Please check your .env file or environment configuration');
} else {
